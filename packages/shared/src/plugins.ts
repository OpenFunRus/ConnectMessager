...
export type TPluginInfo = {
  ...
  enabled: boolean;
  loadError?: string;
  author: TPluginPackageJson['connectmessager']['author'];
  description: TPluginPackageJson['connectmessager']['description'];
  version: TPluginPackageJson['version'];
  logo: TPluginPackageJson['connectmessager']['logo'];
  name: TPluginPackageJson['name'];
  homepage: TPluginPackageJson['connectmessager']['homepage'];
  path: string;
  entry: TPluginPackageJson['connectmessager']['entry'];
};
