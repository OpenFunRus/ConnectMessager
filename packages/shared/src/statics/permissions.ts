export enum Permission {
  ...
  MANAGE_GROUP_CHATS = 'MANAGE_GROUP_CHATS',
  GENERATE_GROUP_INVITES = 'GENERATE_GROUP_INVITES',
  GENERATE_USER_INVITES = 'GENERATE_USER_INVITES'
}
...
export const permissionLabels: Record<Permission, string> = {
  ...
  [Permission.VIEW_SETTINGS_PANEL]: 'View settings panel',
  [Permission.ADD_ROLES]: 'Add roles',
  [Permission.EDIT_ROLES]: 'Edit roles',
  [Permission.MANAGE_GROUP_CHATS]: 'Create and moderate groups',
  [Permission.GENERATE_GROUP_INVITES]: 'Generate group invite codes',
  [Permission.GENERATE_USER_INVITES]: 'Generate user invite codes'
};
...
export const permissionDescriptions: Record<Permission, string> = {
  ...
  [Permission.VIEW_SETTINGS_PANEL]:
    'Grants the ability to open the settings panel.',
  [Permission.ADD_ROLES]:
    'Grants the ability to create new roles.',
  [Permission.EDIT_ROLES]:
    'Grants the ability to update existing roles.',
  [Permission.MANAGE_GROUP_CHATS]:
    'Grants the ability to create, update, and delete role-filtered group chats.',
  [Permission.GENERATE_GROUP_INVITES]:
    'Grants the ability to generate group invite codes.',
  [Permission.GENERATE_USER_INVITES]:
    'Grants the ability to generate user invite codes.'
};
