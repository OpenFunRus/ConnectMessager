...
import { issueLoginCodeRoute } from './issue-login-code';
import { kickRoute } from './kick';
import { provisionRoleAccessRoute } from './provision-role-access';
...
export const usersRouter = t.router({
  ...
  issueLoginCode: issueLoginCodeRoute,
  provisionRoleAccess: provisionRoleAccessRoute,
  kick: kickRoute,
  ban: banRoute,
  unban: unbanRoute,
