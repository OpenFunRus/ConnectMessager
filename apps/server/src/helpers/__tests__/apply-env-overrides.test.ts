...
describe('applyEnvOverrides', () => {
  ...
  test('works with the full config overrides map', () => {
    setEnv('CONNECTMESSAGER_PORT_TEST', '5000');
    setEnv('CONNECTMESSAGER_DEBUG_TEST', 'false');
    setEnv('CONNECTMESSAGER_WEBRTC_PORT_TEST', '50000');
    ...
    const overridesMap = {
      'server.port': 'CONNECTMESSAGER_PORT_TEST',
      'server.debug': 'CONNECTMESSAGER_DEBUG_TEST',
      'mediasoup.webrtcPort': 'CONNECTMESSAGER_WEBRTC_PORT_TEST',
      'mediasoup.announcedAddress': 'CONNECTMESSAGER_ANNOUNCED_ADDRESS_TEST'
    };
