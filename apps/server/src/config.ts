...
config = applyEnvOverrides(config, {
  'server.port': 'CONNECTMESSAGER_PORT',
  'server.debug': 'CONNECTMESSAGER_DEBUG',
  'webRtc.port': 'CONNECTMESSAGER_WEBRTC_PORT',
  'webRtc.announcedAddress': 'CONNECTMESSAGER_WEBRTC_ANNOUNCED_ADDRESS',
  'webRtc.maxBitrate': 'CONNECTMESSAGER_WEBRTC_MAX_BITRATE'
});
